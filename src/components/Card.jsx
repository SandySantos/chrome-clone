export const Card = () => {
  return (
    <div className='bg-[#FEF7E0] rounded-2xl max-w-xl h-full overflow-hidden flex flex-col justify-between'>
      <div className=' p-6 sm:p-10 xl:px-16 py-10 space-y-6 '>
        <h6 className='font-medium text-sm text-gray-500'>LATEST</h6>
        <h1 className='text-5xl font-bold '>New from Chrome</h1>
        ...
        <a
          href='http://'
          className='group flex gap-2 text-lg font-medium text-[#2F75D4]'
        >
      ...
      <div className='hidden sm:flex justify-end items-end h-full'>
        <svg
          xmlns='http://www.w3.org/2000/svg'
          x='0px'
          y='0px'
